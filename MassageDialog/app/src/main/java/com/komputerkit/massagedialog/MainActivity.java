package com.komputerkit.massagedialog;
...
public class MainActivity extends AppCompatActivity {
    ...
    public void showAlert(String pesan){
        ...
        buatAlert.setTitle("Apa Yang Di Cari Orang Sigma?");
    ...
    public void showAlertButton(String pesan){
        ...
        showAlert.setPositiveButton("Iya", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialogInterface, int i) {
                showToast("Data Sudah Di Rizz");
            }
        });
        showAlert.setNegativeButton("tidak", new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialogInterface, int i) {
                showToast("Data Tidak Jadi Di Rizz");
            }
        });
        showAlert.show();
    }
    ...
    public void btnAlert(View view) {
        showAlert("Sigma Skibidi");
    }

    public void btnAlertDialog(View view) {
        showAlertButton("Apakah Anda Mau Ngerizz?");
    }
}